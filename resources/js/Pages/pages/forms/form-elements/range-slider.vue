        ...
        <div class="col-xl-6">
            <div class="card custom-card">
                ...
                <div class="card-body custom-range">
                    <VueSlider v-model="square" :tooltip="'none'" :process-style="{ backgroundColor: 'pink' }"
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <VueSlider class="mb-3" v-for="n in 2" :key="n" v-model="syncMultivalue"
                        :duration="syncMultiinDragging ? 0 : 0.5" @drag-start="() => syncMultiinDragging = true"
                        @drag-end="() => syncMultiinDragging = false"></VueSlider>
                </div>
            </div>
        </div>
        <div class="col-xl-12">
                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            ...
                            <VueSlider class="mb-3" v-model="diffTolltips" :tooltip="'always'"
                                :tooltip-placement="['top', 'bottom']"></VueSlider>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-6">
            <div class="card custom-card">
                ...
                <div class="card-body pb-5">
                    <VueSlider v-model="customLabel" :data="customLabeldata" :marks="true" class="mb-3"></VueSlider>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body pb-5">
                    <VueSlider v-model="independentValue" :order="false" :tooltip="'always'" :process="false"
