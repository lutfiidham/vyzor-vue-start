...
const singleSelecteValue = ref(null)
...
const customValue = ref({
    ...
    img: '/images/flags/canada_flag.jpg'
})

const customOptions = ref([
    { title: 'Space Pirate', desc: 'More space battles!', img: '/images/flags/germany_flag.jpg' },
    { title: 'Merchant', desc: 'PROFIT!', img: '/images/flags/us_flag.jpg' },
    { title: 'Explorer', desc: 'Discovering new species!', img: '/images/flags/canada_flag.jpg' },
    { title: 'Miner', desc: 'We need to go deeper!', img: '/images/flags/spain_flag.jpg' }
])
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <p class="fw-medium mb-2">Default</p>
                            <VueMultiselect :searchable="false" :show-labels="false" placeholder="This is a Placeholder"
                                v-model="singleSelecteValue" :options="singleSelecteOptions"></VueMultiselect>
                            ...
                            <VueMultiselect :searchable="false" :show-labels="false" v-model="groupvalue"
                                ...
                                :group-select="true" placeholder="Choose a city" track-by="name" label="name"><span
                                    slot="noResult">Oops! No
                                    elements found. Consider
                                    changing the search query.</span></VueMultiselect>
                        </div>
