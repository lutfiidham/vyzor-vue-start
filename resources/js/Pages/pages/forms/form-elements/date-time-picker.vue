                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="input-group salesDatePicker">
                            ...
                            <Datepicker class="form-control custom-date-picker custom" autoApply placeholder="Choose date"
                                v-model="picked" />
                        </div>
                    </div>
                </div>
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="input-group input-group-custom">
                            <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                            <Datepicker placeholder="Date Time" class="form-control datepicker-here custom-date-picker custom"
