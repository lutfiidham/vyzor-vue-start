                ...
                <div class="col-xl-12">
                    <ShowcodeCard :code="prism.buttonsAddons" title="Buttons with dropdowns">
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <input type="text" class="form-control custom-drop" aria-label="Text input with 2 dropdown buttons">
                            <button class="btn btn-primary-transparent dropdown-toggle px-1 px-sm-3 custom-group"
