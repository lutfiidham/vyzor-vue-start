                    ...
                    <div class="row gx-5 gy-3">
                        ...
                        <div class="col-xl-12">
                            <div class="d-flex align-items-top justify-content-between mt-sm-0 mt-3">
                                ...
                                <div :class="`toggle toggle-success mb-0 float-sm-end ${success1 ? 'on' : ''}`"
                                    id="push-notifications" @click="handleSuccess1">
                                    <span></span>
                                </div>
                            </div>
                            <div class="d-flex align-items-top justify-content-between mt-3">
                                ...
                                <div :class="`toggle toggle-success mb-0 float-sm-end ${success2 ? 'on' : ''}`"
                                    id="email-notifications" @click="handleSuccess2">
                                    <span></span>
                                </div>
                            </div>
                            <div class="d-flex align-items-top justify-content-between mt-3">
                                ...
                                <div :class="`toggle toggle-success mb-0 float-sm-end ${success3 ? 'on' : ''}`"
                                    id="in-app-notifications" @click="handleSuccess3">
                                    <span></span>
                                </div>
                            </div>
                            <div class="d-flex align-items-top justify-content-between mt-3">
                                ...
                                <div :class="`toggle toggle-success mb-0 float-sm-end ${success4 ? 'on' : ''}`"
                                    id="sms-notifications" @click="handleSuccess4">
                                    <span></span>
                                </div>
                            </div>
                        </div>
