                    ...
                    <div class="card custom-card border-0 my-4">
                        <div class="card-body p-5">
                            ...
                            <form @submit.prevent="handleSubmit">
                                <div class="row gy-3">
                                    ...
                                    <div class="position-relative">
                                        <input :type="values.showPassword ? 'text' : 'password'" class="form-control"
                                            id="signup-password" placeholder="Password" v-model="values.password" />
                                        <a href="#!" class="show-password-button text-muted"
                                            @click.prevent="togglePassword">
                                            <i :class="values.showPassword ? 'ri-eye-line' : 'ri-eye-off-line'"></i>
                                        </a>

                                        <p v-if="errors.password" class="text-danger text-sm mt-1 mb-0">{{ errors.password }}</p>
                                    ...
                                    <div class="mt-2">
                                        <div class="form-check  d-flex gap-2 flex-wrap">
                                            ...
                                            <Link :href="`${baseUrl}/pages/authentication/reset-password/basic/`"
                                                class="float-end link-danger fw-medium fs-12">Forget password ?</Link>
                                        </div>
                                    </div>
                                    </Col>
                                </div>
                            ...
                            <div class="text-center mt-3 fw-medium">
                                Dont have an account? <Link :href="`${baseUrl}/pages/authentication/sign-up/basic`"
