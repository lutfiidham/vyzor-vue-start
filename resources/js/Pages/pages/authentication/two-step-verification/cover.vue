...
<template>
    <Head title="Cover Two-Step-Verification | Vyzor - Laravel & Vue " />
                            ...
                            <form @submit.prevent="handleSubmit">
                                <div class="row gy-3">
                                    <div class="col-xl-12 mb-2">
                                        <div class="row">
                                            <div class="col-3">
                                                <input id="one" type="text" maxlength="1" v-model="inputValues.one"
                                                    @input="handleChange('one', 'two', inputValues.one)"
                                                    @paste="handlePaste"
                                                    class="form-control form-control-lg text-center" />
                                            </div>
                                            <div class="col-3">
                                                <input id="two" type="text" maxlength="1" v-model="inputValues.two"
                                                    @input="handleChange('two', 'three', inputValues.two)"
                                                    class="form-control form-control-lg text-center" />
                                            </div>
                                            <div class="col-3">
                                                <input id="three" type="text" maxlength="1" v-model="inputValues.three"
                                                    @input="handleChange('three', 'four', inputValues.three)"
                                                    class="form-control form-control-lg text-center" />
                                            </div>
                                            <div class="col-3">
                                                <input id="four" type="text" maxlength="1" v-model="inputValues.four"
                                        ...
                                        <div class="form-check mt-3">
                                            ...
                                            <label class="form-check-label" for="defaultCheck1">
                                                ...
                                                <Link :href="`${baseUrl}/applications/email/mail-app`"
