                    ...
                    <div class="card custom-card border-0  shadow-none my-4">
                        <div class="card-body p-5">
                            ...
                            <form @submit.prevent="handleSubmit">
                                <div class="row gy-3">
                                    <div class="col-xl-12"> <label for="signup-username"
                                            class="form-label text-default">User Name</label> <input type="text"
                                            class="form-control" id="signup-username" placeholder="Enter User Name"
                                            value="Tom Phillip"> </div>
                                    <!-- Email Field -->
                                    <div class="col-xl-12">
                                        <label for="signin-email" class="text-default">Email</label>
                                        <input type="email" class="form-control" id="signup-firstname"
                                            placeholder="Enter Email ID" v-model="values.email" />
                                        <p v-if="errors.email" class="text-danger text-sm mt-1 mb-0">{{ errors.email }}</p>
                                    </div>
                                    ...
                                    <div class="col-xl-12 mb-2">
                                        ...
                                        <div class="position-relative">
                                            <input :type="values.showPassword ? 'text' : 'password'"
                                                class="form-control" id="signup-password" placeholder="Password"
                                                v-model="values.password" />
                                            <a href="#!" class="show-password-button text-muted"
                                                @click.prevent="togglePassword">
                                                <i
                                                    :class="values.showPassword ? 'ri-eye-line align-middle' : 'ri-eye-off-line align-middle'"></i>
                                            </a>
                            ...
                            <div class="text-center mt-3 fw-medium">
                                ...
                                <Link :href="`${baseUrl}/pages/authentication/sign-in/basic`" class="text-primary">Sign In
                                </Link>
                            </div>
                        </div>
                    </div>
