        ...
        <div class="col-xl-12">
            <div class="card custom-card invoice-card">
                <div class="card-body">
                    <div class="row gy-3">
                        <div class="col-xl-12">
                            <BaseImg src="/images/brand-logos/desktop-logo.png" alt="" class="img-fluid desktop-logo"/>
                            <BaseImg src="/images/brand-logos/desktop-dark.png" alt="" class="img-fluid desktop-dark"/>
                        </div>
                        <div class="col-xl-12">
                            <div class="row">
                        ...
                        <div class="col-xl-3">
                            ...
                            <p class="fs-15 mb-1">29,Nov 2025 - <span class="text-muted fs-12 d-inline-block">12:42PM</span></p>
                        </div>
                        <div class="col-xl-3">
