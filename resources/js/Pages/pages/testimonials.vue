...
<template>
    ...
    <div class="row gy-5">
        <div class="col-xl-12">
            ...
            <SwiperjsCardComponent :swiperItems="TestimonialData.Reviews"
        ...
        <div class="col-xl-12">
            ...
            <SwiperjsCardComponent :swiperItems="TestimonialData.CustomReviews"
                swiperClass="swiper pagination-dynamic testimonialSwiperService testimonials-swiper-2"
                :slidesPerView="3" :spaceBetween="20" :breakpoints="breakpoints1" :pagination="false"
        ...
        <div class="col-xl-12">
            ...
            <SwiperjsCardComponent :swiperItems="TestimonialData.Testimonials3" swiperClass="swiper testimonialSwiper3"
                :slidesPerView="4" :spaceBetween="20" :breakpoints="breakpoints2" :pagination="false"
                :navigation="false" :autoplay="true">
                <template #default="{ card }">
        ...
        <div class="col-xl-12">
            ...
            <SwiperjsCardComponent :swiperItems="TestimonialData.Testimonialsdata"
                swiperClass="swiper testimonialSwiper1 testimonial-style4" :slidesPerView="3" :spaceBetween="20"
                :breakpoints="breakpoints3" :pagination="false" :navigation="false" :autoplay="true">
                <template #default="{ card }">
