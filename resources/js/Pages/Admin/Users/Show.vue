  ...
  <div>
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
      <div>
        ...
        <p class="mb-0 text-muted">View detailed information about {{ user.name }}</p>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="mb-4">
                  ...
                  <p class="mb-0 fw-medium">{{ new Date(user.created_at).toLocaleDateString() }}</p>
                </div>
                <div class="mb-4">
                  <label class="form-label text-muted">Last Updated</label>
                  <p class="mb-0 fw-medium">{{ new Date(user.updated_at).toLocaleDateString() }}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-3 col-6">
                <div class="text-center">
                  <div class="text-primary fs-24 fw-bold">0</div>
                  <p class="text-muted mb-0">Total Logins</p>
                </div>
              </div>
              <div class="col-md-3 col-6">
                <div class="text-center">
                  <div class="text-success fs-24 fw-bold">0</div>
                  <p class="text-muted mb-0">Actions Performed</p>
                </div>
              </div>
              <div class="col-md-3 col-6">
                <div class="text-center">
                  <div class="text-warning fs-24 fw-bold">0</div>
                  <p class="text-muted mb-0">Files Uploaded</p>
                </div>
              </div>
              <div class="col-md-3 col-6">
                <div class="text-center">
                  <div class="text-info fs-24 fw-bold">0</div>
