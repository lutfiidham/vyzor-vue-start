...
<template>
  ...
  <div>
            ...
            <div class="d-flex align-items-start justify-content-between">
              <div>
                ...
                <span class="badge bg-primary-transparent">
                  <i class="ri-shield-user-line me-1" />Active
                </span>
              </div>
              <div>
                <span class="avatar avatar-lg bg-primary-transparent">
                  <i class="ri-shield-user-line fs-4" />
                </span>
              </div>
            </div>
          </div>
            ...
            <div class="d-flex align-items-start justify-content-between">
              <div>
                ...
                <span class="badge bg-success-transparent">
                  <i class="ri-key-line me-1" />Available
                </span>
              </div>
              <div>
                <span class="avatar avatar-lg bg-success-transparent">
                  <i class="ri-key-line fs-4" />
                </span>
              </div>
            </div>
          </div>
            ...
            <div class="d-flex align-items-start justify-content-between">
              <div>
                ...
                <span class="badge bg-info-transparent">
                  <i class="ri-user-line me-1" />With Roles
                </span>
              </div>
              <div>
                <span class="avatar avatar-lg bg-info-transparent">
                  <i class="ri-user-settings-line fs-4" />
                </span>
              </div>
            </div>
          </div>
            ...
            <div class="d-flex align-items-start justify-content-between">
              <div>
                ...
                <span class="badge bg-warning-transparent">
                  <i class="ri-folders-line me-1" />Categories
                </span>
              </div>
              <div>
                <span class="avatar avatar-lg bg-warning-transparent">
                  <i class="ri-folders-line fs-4" />
                </span>
              </div>
            </div>
          </div>
          ...
          <div class="card-header justify-content-between">
            <ul class="nav nav-tabs nav-tabs-header mb-0 d-sm-flex d-block" role="tablist">
              <li class="nav-item m-1">
                ...
                >
                  <i class="ri-shield-user-line me-1" />Roles
                </a>
              </li>
              <li class="nav-item m-1">
                <a
                ...
                >
                  <i class="ri-key-line me-1" />Permissions
                </a>
              </li>
            </ul>
            <div>
                  ...
                  <div class="card-body">
                        ...
                        <ul class="dropdown-menu">
                          <li>
                            <a
                              ...
                              @click="viewRole(role)"
                            >
                              <i class="ri-eye-line me-2" />View Details
                            </a>
                          </li>
                          <li>
                            <a
                              ...
                              @click="editRole(role)"
                            >
                              <i class="ri-pencil-line me-2" />Edit
                            </a>
                          </li>
                          <li>
                          ...
                          <li>
                            ...
                            >
                              <i class="ri-delete-bin-line me-2" />Delete
                            </a>
                          </li>
                        </ul>
                      </div>
                    ...
                    <div class="d-flex gap-2">
                      <button
                        ...
                        @click="viewRole(role)"
                      >
                        <i class="ri-eye-line me-1" />View
                      </button>
                      <button
                        class="btn btn-sm btn-success-light flex-fill"
                        @click="editRole(role)"
                      >
                        <i class="ri-pencil-line me-1" />Edit
                      </button>
                    </div>
                  </div>
                </div>
                    ...
                    <tr v-for="permission in localPermissions" :key="permission.id">
                      ...
                      <td>
                        <span class="badge bg-light text-dark">
                          <i class="ri-key-line me-1" />{{ permission.name }}
                        </span>
                      </td>
                      <td>
                        <span class="badge bg-primary-transparent">
    ...
    <div v-show="activeTab === 'roles'" class="row">
      <div class="col-xl-12">
        <div class="card custom-card">
          ...
          <div class="card-body">
            ...
            >
              <div v-for="(group, index) in permissionGroups" :key="index" class="accordion-item">
        ...
        <div class="modal-content">
                ...
                <div class="col-xl-12 mb-3">
                  ...
                  >
                    <div v-if="viewRolePermissionGroups.length > 0">
                      ...
                      >
                        <div class="fw-semibold mb-2 text-primary">
                          <i class="ri-key-line me-1" />{{ group.name }}
                        </div>
                        <div class="ms-4">
                          <div
                            v-for="permission in group.permissions"
                          ...
                          >
                            <i class="ri-checkbox-circle-fill text-success me-2" />
                    ...
                    <div v-else class="text-muted text-center py-3">
                      <i class="ri-information-line me-1" />No permissions assigned to this role
                    </div>
                  </div>
          ...
          <div class="modal-footer">
            ...
            <button v-if="!viewingRole" type="button" class="btn btn-primary" @click="saveRole">
              <i class="ri-save-line me-1" />Save Role
            </button>
          </div>
        </div>
      </div>
    ...
    >
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h6 id="permissionModalLabel" class="modal-title">
          ...
          <div class="modal-body">
            <form @submit.prevent="savePermission">
              <div class="mb-3">
                ...
                >
                <div class="form-text">
                  Use lowercase with dots (.) for separation. Format: <code>module.action</code><br>
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-success" @click="savePermission">
              <i class="ri-save-line me-1" />Save Permission
            </button>
          </div>
        </div>
      </div>
    ...
    >
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h6 id="bulkPermissionModalLabel" class="modal-title">
              <i class="ri-flashlight-line me-2" />Quick Add CRUD Permissions
            </h6>
                  ...
                  <div class="col-6">
                    <div class="form-check">
                      ...
                      <label class="form-check-label" for="action_view">
                        <i class="ri-eye-line me-1 text-primary" />
                        <strong>View</strong>
                  ...
                  <div class="col-6">
                    <div class="form-check">
                      ...
                      <label class="form-check-label" for="action_create">
                        <i class="ri-add-line me-1 text-success" />
                  ...
                  <div class="col-6">
                    <div class="form-check mt-2">
                      ...
                      <label class="form-check-label" for="action_edit">
                        <i class="ri-pencil-line me-1 text-warning" />
                        <strong>Edit</strong>
                  ...
                  <div class="col-6">
                    <div class="form-check mt-2">
                      ...
                      <label class="form-check-label" for="action_delete">
                        <i class="ri-delete-bin-line me-1 text-danger" />
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" @click="saveBulkPermissions">
              <i class="ri-flashlight-line me-1" />Create Permissions
            </button>
          </div>
        </div>
      </div>
