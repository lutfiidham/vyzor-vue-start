    ...
    <div class="chat-info border">
      <div class="d-flex align-items-center justify-content-between w-100 p-3 border-bottom">
        ...
        <div class="dropdown ms-2">
          <button
            aria-label="button"
            class="btn btn-icon btn-light btn-wave waves-light btn-sm"
            type="button"
      ...
      >
        <li class="nav-item me-0" role="presentation">
          <button
            ...
            aria-selected="true"
          >
            Recents<span class="badge bg-secondary ms-1 rounded-pill">04</span>
          </button>
        </li>
        <li class="nav-item me-0" role="presentation">
          <button
              ...
              <li v-for="idx in ChatData.GroupChats" :key="idx.id">
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="avatar-list-stacked my-auto">
                    ...
                    <a
                      class="avatar avatar-sm bg-primary avatar-rounded"
    ...
    <div class="main-chat-area border">
              ...
              <div class="chat-list-inner">
                ...
                <div class="ms-3">
                  <span class="chatting-user-info">
                    <span class="chatnameperson">{{ activeUser.name }}</span>
              ...
              <div class="chat-list-inner">
                <div class="me-3">
                  ...
                  <div class="main-chat-msg">
                    <div>
                      <p class="mb-0">
                        Almost! Just need to finalize a few things. I should be done by the end of
                        the day.
                      </p>
                    </div>
                  </div>
              ...
              <div class="chat-list-inner">
                <div class="me-3">
                  ...
                  <div class="main-chat-msg">
                    <div class="">
                      <p class="mb-0">
                        Thanks! Actually, I was thinking of adding a new section to the report. What
                        do you think about including a summary of our recent team discussions?
                        &#128528;
                      </p>
                    </div>
                  </div>
              ...
              <div class="chat-list-inner">
                ...
                <div class="ms-3">
                  ...
                  <div class="main-chat-msg">
                    <div>
                      <p class="mb-0">
                        That’s a great idea! It will definitely add more value. I can help with
                        writing it if you’d like.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <div class="chat-footer">
        ...
        <div
          v-if="showPicker"
          ref="pickerRef"
          style="position: absolute; z-index: 1000; bottom: 4rem"
        >
          ...
          <ul class="shared-files list-unstyled">
              ...
              <div class="d-flex align-items-center">
                <div class="lh-1">
                  <span class="avatar avatar-lg">
                    <BaseImg src="/images/media/files/1.png" alt="" />
                  </span>
                </div>
                <div class="flex-fill">
            ...
            <li>
              <div class="d-flex align-items-center">
                <div class="lh-1">
                  <span class="avatar avatar-lg">
                    <BaseImg src="/images/media/files/2.png" alt="" />
                  </span>
                </div>
                <div class="flex-fill">
            ...
            <li>
              <div class="d-flex align-items-center">
                <div class="lh-1">
                  <span class="avatar avatar-lg">
                    <BaseImg src="/images/media/files/3.png" alt="" />
                  </span>
                </div>
            ...
            <li>
              <div class="d-flex align-items-center">
                <div class="lh-1">
                  <span class="avatar avatar-lg">
                    <BaseImg src="/images/media/files/4.png" alt="" />
                  </span>
                </div>
                <div class="flex-fill">
