  ...
  <div class="row">
    ...
    <div class="col-xl-6">
      <ShowcodeCard title="Horizontal rules" :code="prism.horizontalrules">
        <p class="mb-1">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum dolorem fuga iste obcaecati
          natus eos officiis adipisci voluptatibus ipsum, architecto veniam delectus vel dolor magni
