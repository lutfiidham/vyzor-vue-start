...
<div class="row">
    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <SpkCardComponent titleClass="fw-medium" imgClass="card-img-top" imgSrc="/images/media/media-24.jpg" title="Card title">
    ...
    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <SpkCardComponent titleClass="fw-medium" imgClass="card-img-top" footer="<span class='card-text'>Last updated 3 mins ago</span>" imgSrc="/images/media/media-22.jpg" title="Card title">
            <template v-slot:bodyText>
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4">
                        <SpkCardComponent cardClass="overflow-hidden" headerText="Featured" :header="true" :useDivHeader="true" :bodyText="false">
                            <template v-slot:outBodyText>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">An item</li>
                                    <li class="list-group-item">A second item</li>
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4">
                        <SpkCardComponent cardClass="overflow-hidden" footer="Card footer" cardFooter="border-top-0" :bodyText="false">
                            <template v-slot:outBodyText>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">An item</li>
                                    <li class="list-group-item">A second item</li>
...
<div class="row">
    <div class="col-xl-3">
        <SpkCardComponent cardClass='text-center' cardHeader="border-bottom-0 pb-0" :useDivHeader="true" bodyClass="pt-1" :header="true">
    ...
    <div class="col-xl-3">
        <SpkCardComponent cardClass="border border-primary" footer="Lorem Ipsum is therefore always free from repetition, injected humour.">
            <template v-slot:bodyText>
                <svg class="footer-card-icon my-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <path d="M16 22.75c-3.08 0-5.704-1.97-6.696-4.713C10.18 20.907 12.85 23 16 23s5.82-2.094 6.696-4.963C21.704 20.781 19.08 22.75 16 22.75z" opacity=".1" />
                    <path fill="#FFF" d="M16 9.25c3.08 0 5.704 1.97 6.696 4.713C21.82 11.093 19.15 9 16 9s-5.82 2.094-6.696 4.963C10.296 11.219 12.92 9.25 16 9.25z" opacity=".2" />
                    ...
                    <path fill="#FFF" d="M19 1H3a2 2 0 0 0-2 2v.25a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2V3a2 2 0 0 0-2-2z" opacity=".2" />
                    ...
                    <path fill="url(#b)" d="M21 11.11V3a2 2 0 0 0-2-2H3a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h8.11A6.974 6.974 0 0 0 16 23c3.86 0 7-3.14 7-7a6.974 6.974 0 0 0-2-4.89z" />
                </svg>
    ...
    <div class="col-xl-3">
        <SpkCardComponent :useDivHeader="true" :header="true" :footer="true" bodyClass="pt-3" cardHeader="border-bottom-0 pb-0">
            <template v-slot:header>
                <div>
    ...
    <div class="col-xl-3">
        <SpkCardComponent headerText="Featured" :header="true" titleClass="fw-medium mb-2" cardClass="text-center" cardFooter="text-muted" footer="11.32pm">
            <template v-slot:bodyText>
    ...
    <div class="col-xl-4">
        ...
        <SpkCollapseCard :collapseToggle="true" Text="Card With Collapse Button" Customheaderclass="border-bottom-0">
...
<div class="row">
    <div class="col-xl-3">
        <div class="row">
            ...
            <div class="col-xl-12">
                <SpkCardComponent :useDivHeader="true" cardClass="border border-success mb-3" :header="true" headerText="Header" cardHeader="bg-transparent border-bottom border-success" bodyClass="text-success" cardFooter="bg-transparent border-top border-success" footer="Footer">
                    <template v-slot:bodyText>
...
<div class="row">
    <div class="col-xxl-6 col-xl-12">
        ...
        <div class="row">
            <div class="col-xl-6">
                <SpkCardComponent :header="true" headerText="Using Width 75%" footer="<a href='#!' class='btn btn-primary d-grid'>Button</a>" cardClass="w-75">
                    <template v-slot:bodyText>
                        <div class="card-text">
            ...
            <div class="col-xl-6">
                <SpkCardComponent :header="true" headerText="Using Width 50%" footer="<a href='#!' class='btn btn-primary d-grid'>Button</a>" cardClass="w-50">
                    <template v-slot:bodyText>
                        <div class="card-text">
...
<div class="row">
    ...
    <div class="col-xl-4">
        ...
        <SpkCardComponent imgSrcB="/images/media/media-31.jpg" imgClassB="card-img rounded-0" :header="true" headerText="Image caps are widely used in Blog's" footer="<p class='card-text mb-0'><small>Last updated 3 mins ago</small></p>">
            <template v-slot:bodyText>
    ...
    <div class="col-xl-4">
        <SpkCardComponent imgSrcA="/images/media/media-32.jpg" imgClassA="card-img-top" :header="true" headerText="Image caps are widely used in Blog's" footer="<p class='card-text mb-0'><small>Last updated 3 mins ago</small></p>">
            <template v-slot:bodyText>
                <p class="card-text mb-1 text-muted">This is a wider card with supporting text below
                    as
                    a natural lead-in to additional content. This content is a
    ...
    <div class="col-xl-4">
        <SpkCardComponent imgSrcB="/images/media/media-30.jpg" imgClassB="card-img rounded-0" footer="<p class='card-text mb-0'><small>Last updated 3 mins ago</small></p>">
            <template v-slot:bodyText>
    ...
    <div class="col-xl-4">
        <SpkCardComponent imgSrcC="/images/media/media-33.jpg" imgClassC="card-img-bottom" :footer="true" :header="true" headerText="Image caps are widely used in Blog's">
            <template v-slot:footer>
                <p class="card-text mb-0"><small>Last updated 3 mins
                        ago</small></p>
            </template>
...
<div class="row">
    <div class="col-xl-4">
        <SpkImageOverlayCard CustomClass="overlay-card" Imgsrc="/images/media/media-35.jpg" Title="Image Overlays Are Awesome!" CustomTitleclass="text-fixed-white" :CardHeader="true" :CardFooter="false" Custombodyclass="text-fixed-white overflow-y-auto">
    ...
    <div class="col-xl-4">
        <SpkImageOverlayCard CustomClass="overlay-card" Custombodyclass="text-fixed-white" Footertext="Last updated 3 mins ago" Imgsrc="/images/media/media-36.jpg" Customfooterclass="text-fixed-white p-sm-3 p-2" Overlayclass="over-content-bottom" :CardHeader="false" :CardFooter="true">
            <template v-slot:cardContent>
                <div class="card-text text-fixed-white">
                    Image Overlays Are Awesome!
                </div>
                <div class="card-text card-text1 mb-2">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even.</div>
                <div class="card-text">Last updated 3 mins ago</div>
            </template>
        </SpkImageOverlayCard>
    </div>
    <div class="col-xl-4">
        <SpkImageOverlayCard CustomClass="overlay-card" Customheaderclass="p-sm-3 p-2" Title=" Image Overlays Are Awesome!" CustomTitleclass="text-fixed-white" Imgsrc="/images/media/media-34.jpg"  Custombodyclass="text-fixed-white overflow-y-auto" Customfooterclass="text-fixed-white py-2 py-sm-3" :CardHeader="true" :CardFooter="true" Footertext="Last updated 3 mins ago">
            <template v-slot:cardContent>
...
<div class="row">
    <div class="col-xl-4">
        <SpkHorizontalCard :CardHeader="true" Navigate="javascript:void(0);" Imgposition="before" Imagesrc="/images/media/media-37.jpg" Imgclass="img-fluid rounded-start h-100 w-100" Title="Horizontal Cards" CardFooter="true" Footertext="Last updated 3 mins ago">
            <template v-slot:cardContent>
    ...
    <div class="col-xl-4">
        <SpkHorizontalCard :CardHeader="true" Navigate="javascript:void(0);" Imgposition="after" Imagesrc="/images/media/media-38.jpg" Title="Horizontal Cards">
            <template v-slot:cardContent>
                <h6 class="card-title fw-medium">Horizontal cards are awesome!</h6>
    ...
    <div class="col-xl-4">
        <SpkHorizontalCard :CardFooter="true" Navigate="javascript:void(0);" Footertext="Last updated 3 mins ago" Imgposition="after" Imagesrc="/images/media/media-39.jpg">
            <template v-slot:cardContent>
...
<div class="row">
    <div class="col-xl-3">
        <SpkBackgroundCard Navigate="javascript:void(0);" color="primary" Imgsrc="/images/faces/11.jpg" Title="Adam Smith" Value="Finished by today" Textclass="fixed-white" Class="fixed-white" />
    </div>
    <div class="col-xl-3">
        <SpkBackgroundCard Navigate="javascript:void(0);" color="secondary" Imgsrc="/images/faces/12.jpg" Title="Elisha Corner" Value="Completed 24 days back" Textclass="fixed-white" Class="fixed-white" />
    </div>
    <div class="col-xl-3">
        <SpkBackgroundCard Navigate="javascript:void(0);" color="warning" Imgsrc="/images/faces/1.jpg" Title="Sarah Alina" Value="Completed today" Textclass="fixed-white" Class="fixed-white" />
    </div>
    <div class="col-xl-3">
        <SpkBackgroundCard Navigate="javascript:void(0);" color="info" Imgsrc="/images/faces/8.jpg" Title="Monica Karen" Value="Pending from 4 days" Textclass="fixed-white" Class="fixed-white" />
    </div>
    <div class="col-xl-3">
        <SpkBackgroundCard Navigate="javascript:void(0);" color="success" Imgsrc="/images/faces/5.jpg" Title="Samantha sid" Value="In leave for 1 month" Textclass="fixed-white" Class="fixed-white" />
    </div>
    <div class="col-xl-3">
        <SpkBackgroundCard Navigate="javascript:void(0);" color="danger" Imgsrc="/images/faces/14.jpg" Title="Sebastien steyn" Value="Completed by Tomorrow" Textclass="fixed-white" Class="fixed-white" />
    </div>
    <div class="col-xl-3">
        <SpkBackgroundCard Navigate="javascript:void(0);" color="light" Imgsrc="/images/faces/13.jpg" Title="Jacob Smith" Value="Finished by 24,Nov" Textclass="muted" Class="text-default" />
    </div>
    <div class="col-xl-3">
        <SpkBackgroundCard Navigate="javascript:void(0);" color="dark" Imgsrc="/images/faces/16.jpg" Title="Pope Adam" Value="Completed on 24,may" Textclass="text-white" Class="white" />
    </div>
</div>
<!-- End::row-9 -->
...
<div class="row">
    <div class="col-xl-3" v-for="(idx,index) in cardData.borderCards" :key="index">
        <SpkBorderdCard Navigate="javascript:void(0);" :Title="idx.title" :badges="idx.badges" :images="idx.images" :Class="idx.Class" :Color="idx.Color" />
    </div>
</div>
<!-- End::row-10 -->
...
<div class="row">
    <div class="col-xl-12">
        <div class="card-group">
            <SpkCardComponent imgSrcA="/images/media/media-40.jpg" imgClassA="card-img-top" footer="<small class='text-muted'>Last updated 3 mins ago</small>">
                <template v-slot:bodyText>
            ...
            <SpkCardComponent imgSrcA="/images/media/media-42.jpg" imgClassA="card-img-top" footer="<small class='text-muted'>Last updated 3 mins ago</small>">
                <template v-slot:bodyText>
            ...
            <SpkCardComponent imgSrcA="/images/media/media-41.jpg" imgClassA="card-img-top" footer="<small class='text-muted'>Last updated 3 mins ago</small>">
                <template v-slot:bodyText>
...
<div class="row">
    <div class="col-xxl-3 col-xl-12">
        <SpkCardComponent imgSrcA="/images/media/media-23.jpg" imgClassA="card-img-top" linkTag={true} titleClass="fw-medium mb-0" title="Forests are Awesome." />
    </div>
    <div class="col-xxl-6 col-xl-6">
        <div class="row">
            ...
            <div class="col-xxl-7 col-xl-12">
                <SpkHorizontalCard :Linktag="true" Navigate="javascript:void(0);" Imgposition="after" :CardFooter="true" Imagesrc="/images/media/media-39.jpg" Footertext="Last updated 3 mins ago">
                    <template v-slot:cardContent>
    ...
    <div class="col-xxl-3 col-xl-6">
        <SpkCardComponent imgSrcA="/images/media/media-47.jpg" imgClassA="card-img-top" :linkTag="true">
            <template v-slot:bodyText>
                <h6 class="card-title fw-medium">Most tropical areas are suitable</h6>
                <p class="card-text"> If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
            </template>
