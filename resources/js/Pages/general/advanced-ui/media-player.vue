...
<template>
    <Head title="Media Player | Vyzor - Laravel & Vue " />
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <video id="player" playsinline controls poster="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-HD.jpg"
        ...
        <div class="col-xl-12">
            <div class="card custom-card overflow-hidden">
                ...
                <div class="card-body">
                    <div class="plyr__video-embed" id="player1" style="aspect-ratio: 16 / 9;">
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <audio id="player2" controls>
                        <source :src="`${baseUrl}/audio/perfect-beauty.mp3`" type="audio/mp3">
                    </audio>
                </div>
            </div>
        </div>
