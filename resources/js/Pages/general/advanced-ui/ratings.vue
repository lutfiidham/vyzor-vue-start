                ...
                <div class="card-body">
                    <div class="mb-4 row gy-3">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="number" class="form-control" placeholder="Number"
                                v-model.number="numberOfStars" min="1" max="10" @input="clampStars">
                        </div>
                        <div class="col-12 col-md-6">
                            <label for="input-label" class="form-label">Star Size (px):</label>
                            <input type="number" class="form-control" placeholder="Size" v-model.number="starSize"
                                min="1" max="50" @input="clampSize">
                        </div>
                        <div class="col-12 col-md-6">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <div id="rater-basic" class="star-scroll-wrapper">
                            <vue3starRatings v-model="myRating" :numberOfStars="numberOfStars" :starSize="starSize"
                                :starColor="starColor" :inactiveColor="inactiveColor" />
                        </div>
                    </div>
                </div>
            </div>
