                ...
                <div class="card-body p-5 text-center">
                    <div class="row justify-content-center">
                        <div class="col-xl-7 mb-5">
                            ...
                            <span class="text-muted">Embark on a journey of discovery with our exclusive tour
                                experiences. Whether you're a solo adventurer, a couple seeking romance, or a group of
                                friends ready for excitement, we've curated the perfect tours for you. Create memories
                                that last a lifetime.</span>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card shadow-none bg-primary-transparent">
                                <div class="card-body p-5 text-center">
                                        ...
                                        <span
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                                                ...
                                                <path
                                                    ...
                                                    fill="none" stroke="currentColor" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="16"></path>
                                                <line x1="128" y1="104.52" x2="128" y2="224" fill="none"
                                    ...
                                    <span class="fs-14 text-muted">Explore destinations, reviews, and user favorites for
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card shadow-none bg-secondary-transparent">
                                <div class="card-body p-5">
                                    ...
                                    <span class="fs-14 text-muted">Estimate expenses, find exclusive deals, and plan
                                        within your budget.</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3">
                            <div class="card custom-card shadow-none bg-success-transparent">
                                <div class="card-body p-5">
                                    ...
                                    <span class="fs-14 text-muted">Secure travel and stay with diverse options and
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card shadow-none bg-orange-transparent">
                                <div class="card-body p-5">
                                        ...
                                        <span
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                                                ...
                                                <path
                                                    ...
                                                    opacity="0.2"></path>
                                                <path d="M196.06,195.91a96,96,0,0,1-.12-135.65h0a96,96,0,0,1,0,135.53Z"
                                                    opacity="0.2"></path>
                                                <circle cx="128" cy="128" r="96" fill="none" stroke="currentColor"
                                                    stroke-linecap="round" stroke-linejoin="round" stroke-width="16">
                                                </circle>
                                                <path d="M60,60.24A95.7,95.7,0,0,1,88,128a95.7,95.7,0,0,1-28,67.76"
                                                    fill="none" stroke="currentColor" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="16"></path>
                                                <path d="M196,60.24a96,96,0,0,0,0,135.52" fill="none"
                                                    stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="16"></path>
                                                <line x1="32" y1="128" x2="224" y2="128" fill="none"
                                                    stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="16"></line>
                                                <line x1="128" y1="32" x2="128" y2="224" fill="none"
                                                    stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="16"></line>
                                            </svg>
                                        </span>
                                    ...
                                    <span class="fs-14 text-muted">Discover attractions, create itineraries, and explore
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card shadow-none bg-info-transparent">
                                <div class="card-body p-5">
                                    ...
                                    <span class="fs-14 text-muted">Stay connected, receive real-time updates, and
