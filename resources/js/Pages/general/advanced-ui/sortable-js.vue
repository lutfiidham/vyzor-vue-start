<script setup>
import { tasks, Drag1, Drag2, Drag9, Drag8, Drag3, Drag5, Drag10, sortlist, Drag4, Drag7, Drag6, Drag11 } from "@/shared/data/sortable"
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <ol class="list-group sortable-list list-item-numbered" id="sorting-with-handle">
                        <Sortable :list="sortList" item-key="id" :handle="'.handle'" :options="sortableOptionhandle" >
                            <template #item="{ element }">
