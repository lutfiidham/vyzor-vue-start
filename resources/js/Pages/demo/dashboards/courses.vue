        ...
        <div class="card-header flex-between justify-content-between">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              ...
              <li>
                <a class="dropdown-item border-bottom" href="javascript:void(0);">This Week</a>
              </li>
              <li>
                <a class="dropdown-item border-bottom" href="javascript:void(0);">Last Week</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="table-responsive">
            <TableComponent
              ...
              :headers="[
                ...
                { text: 'Total Enrolled', thClass: '' },
                { text: 'Average Rating', thClass: '' },
                { text: 'Status', thClass: '' },
                { text: 'Revenue', thClass: '' },
