  ...
  <div class="row">
    <div class="col-xxl-6">
      <div class="card custom-card">
        <div class="card-header justify-content-between">
          ...
          <div class="btn-list">
            ...
            >
              <i class="ri-add-line align-middle me-1 fw-medium" />Create Project
            </Link>
            <a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-wave"><i class="ri-share-line align-middle fw-medium me-1" />Share</a>
          </div>
        </div>
        <div class="card-body">
          <div class="d-flex align-items-center mb-4 gap-2 flex-wrap">
            <div class="lh-1">
              <span class="avatar avatar-lg me-1 bg-primary"><i class="ri-stack-line fs-24 lh-1" /></span>
            </div>
            <div>
              ...
              <span class="text-muted fs-12"><i class="ri-circle-fill text-success mx-2 fs-9" />Last Updated 1 Day Ago</span>
            </div>
            <div class="ms-auto align-self-start">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  <li>
                    <a class="dropdown-item" href="javascript:void(0);"><i class="ri-eye-line align-middle me-1 d-inline-block" />View</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="javascript:void(0);"><i class="ri-edit-line align-middle me-1 d-inline-block" />Edit</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="javascript:void(0);"><i class="ri-delete-bin-line me-1 align-middle d-inline-block" />Delete</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <p class="text-muted mb-4">
            The Customer Feedback Dashboard Development project aims to create a comprehensive
            dashboard that aggregates and visualizes customer feedback data. This will enable our
            team to gain actionable insights and improve customer satisfaction.
          </p>
          <div class="d-flex gap-5 mb-4 flex-wrap">
            <div class="d-flex align-items-center gap-2 me-3">
              <span class="avatar avatar-md avatar-rounded me-1 bg-success"><i class="ri-calendar-event-line fs-18 lh-1 align-middle" /></span>
              <div>
            ...
            <div class="d-flex align-items-center gap-2 me-3">
              <span class="avatar avatar-md avatar-rounded me-1 bg-info"><i class="ri-time-line fs-18 lh-1 align-middle" /></span>
              <div>
                <div class="fw-medium mb-0">
                  End Date
                </div>
            ...
            <div class="row gy-3">
              <div class="col-xl-12">
                ...
                <ul class="task-details-key-tasks mb-0">
                  ...
                  <li>
                    Coding and development of the website interface, functionality, and integration.
                  </li>
              ...
              <div class="col-xl-12">
                ...
                <ul class="list-group">
                  <li
                    v-for="idx in ProjectOverview.Tasks"
                    :key="idx.id"
                    :class="`list-group-item ${idx.liClass}`"
                  >
                    <div class="d-flex align-items-center">
                      <div class="me-2">
                        <i class="ri-link fs-15 lh-1 p-1 bg-primary-transparent rounded-circle" />
                      </div>
                      <div class="fw-medium">
                        {{ idx.title }}
                      </div>
          ...
          <div class="d-flex gap-2 flex-wrap">
            <span
              v-for="idx in ProjectOverview.Badges"
              :key="idx.id"
              :class="`badge bg-${idx.className}-transparent`"
            >{{ idx.label }}</span>
          </div>
        </div>
      ...
      <div class="card custom-card overflow-hidden">
        <div class="card-header justify-content-between">
          ...
          <div class="dropdown">
            <div class="btn btn-light btn-full btn-sm" data-bs-toggle="dropdown">
              View All<i class="ti ti-chevron-down ms-1 d-inline-block" />
            </div>
        ...
        <div class="card-body p-0">
          <ul class="list-group list-group-flush">
            <li v-for="idx in ProjectOverview.Filedocument" :key="idx.id" class="list-group-item">
              <div class="d-flex align-items-center flex-wrap gap-2">
                ...
                <div class="btn-list">
                  <button class="btn btn-sm btn-icon btn-info-light btn-wave">
    ...
    <div class="col-xxl-6">
          ...
          <ul class="list-unstyled project-timeline">
            <li v-for="idx in ProjectOverview.TimelineMessages" :key="idx.id">
              <div>
                ...
                <p v-if="idx.attachment" class="project-activity-media mb-0">
                  <a href="javascript:void(0);">
                    <BaseImg
                      src="/images/media/file-manager/3.png"
                      alt=""
          ...
          <div class="d-sm-flex align-items-center lh-1">
            ...
            <div class="flex-fill">
              <div class="input-group flex-nowrap custom-inputgroup">
                <input
                  type="text"
                  class="form-control w-sm-50 border shadow-none"
                  placeholder="Share your thoughts"
                  aria-label="Recipient's username with two button addons"
                >
                <button class="btn btn-primary-light btn-sm btn-wave" type="button">
                ...
                <button class="btn btn-primary btn-wave text-nowrap" type="button">
                  Post
                </button>
              </div>
            </div>
      ...
      <div class="card custom-card overflow-hidden">
        ...
        <div id="todo-content" class="card-body p-0 position-relative">
          <div>
            <div class="table-responsive">
              <table class="table text-nowrap todo-tasks-table">
                ...
                <Draggable id="todo-drag" tag="tbody" item-key="id">
                  <tr v-for="idx in ProjectOverview.TodoItems" :key="idx.id" class="todo-box">
                    ...
                    <td>
                      <span :class="`badge bg-${idx.badgeClass}-transparent`"><i class="ri-circle-line fw-semibold fs-7 me-2 lh-1 align-middle" />{{ idx.status }}</span>
                    </td>
                    <td>
                      {{ idx.date }}
                    </td>
