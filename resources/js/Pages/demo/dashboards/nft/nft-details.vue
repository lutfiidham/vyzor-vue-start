                        ...
                        <div class="col-xxl-4 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                          ...
                          >
                            ...
                            <div class="progress progress-xs flex-fill">
                              <div
                                :class="`progress-bar bg-${idx.color}`"
                                role="progressbar"
                                :style="`width: ${idx.percentage}%`"
                                aria-valuenow="55"
                                aria-valuemin="0"
                                aria-valuemax="100"
                              ></div>
                          ...
                          <div class="border rounded p-3">
                            ...
                            <div class="mb-3">
                              ...
                              <p class="mb-0 fs-12 text-muted">
                                ...
                                unique. I’m beyond excited to own such a one-of-a-kind digital
                                asset. A perfect addition to any collection!
                              </p>
                            </div>
