  ...
  <div class="row">
          ...
          <div class="card custom-card">
            <div class="card-header justify-content-between">
              ...
              <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                ...
                <button
                  type="button"
                  class="btn btn-primary-light btn-wave waves-effect waves-light"
                >
                  Week
                </button>
                <button
    ...
    <div class="col-xxl-3">
      <div class="row">
        <div class="col-xl-12">
          <div
            class="card custom-card shadow-none card-bg-primary overflow-hidden dashboard-banner-card"
          >
            <div class="card-body">
      ...
      <div class="card custom-card overflow-hidden">
        ...
        <div class="card-body p-0">
          <ul class="list-group list-group-flush">
            <li
              v-for="(product, index) in salesData.topSellingProducts"
              :key="index"
          ...
          >
            ...
            <td :class="row.tableClass">
              <div class="avatar-list-stacked">
                <span
                  v-for="(image, index) in row.avatars"
                  :key="index"
                  class="avatar avatar-rounded avatar-sm bg-light"
                  data-bs-toggle="tooltip"
                  data-bs-placement="top"
                  data-bs-title="Mikon Camera"
