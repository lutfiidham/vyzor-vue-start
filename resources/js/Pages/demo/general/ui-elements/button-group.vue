...
import * as prism from '@/shared/data/prismCode/ui-elements/button-group'
...
<template>
  <Head title="Button-Groups | Vyzor - Laravel & Vue " />
  ...
  <div class="row">
    ...
    <div class="col-xl-6">
      <ShowcodeCard title="Navigation" :code="prism.Navigation">
        <div class="btn-group">
          <a href="javascript:void(0);" class="btn btn-primary active btn-wave" aria-current="page">Active link</a>
    ...
    <div class="col-xl-6">
      <ShowcodeCard title="Mixed style" :code="prism.MixedStyle">
        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
          <button type="button" class="btn btn-danger btn-wave">
            Left
          </button>
    ...
    <div class="col-xl-6">
      <ShowcodeCard
        ...
        :code="prism.CheckboxButtonGroups"
    ...
    <div class="col-xl-12">
      <ShowcodeCard title="Button toolbar" :code="prism.ButtonToolbar">
        ...
        <div
          class="btn-toolbar justify-content-between d-sm-flex d-block"
          role="toolbar"
        ...
        >
          ...
          <div class="input-group">
            <div id="btnGroupAddon2" class="input-group-text">
              @
            </div>
            <input
              type="text"
