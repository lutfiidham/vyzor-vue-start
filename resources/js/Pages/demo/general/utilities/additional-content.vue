        ...
        <div class="card-body overflow-x-auto">
          ...
          <div style="height: 100px; background-color: rgba(255, 0, 0, 0.1)" class="d-flex">
            <div
              ...
              style="width: 120px; background-color: rgba(0, 0, 255, 0.1); padding-inline: 10px"
            >
              H 25%
            </div>
            <div
              class="h-50 d-inline-block"
              style="width: 120px; background-color: rgba(0, 0, 255, 0.1); padding: 10px"
            >
              H 50%
            </div>
            <div
            ...
            <div
              class="h-auto d-sm-inline-block d-none"
              style="width: 120px; background-color: rgba(0, 0, 255, 0.1); padding: 10px"
            >
              H auto
            </div>
      ...
      <div class="card custom-card">
        <div class="card-header">
          <div class="card-title">
            You can also use <span class="text-danger"> max-width: 100%;</span> and
            <Span class="text-danger">max-height: 100%;</Span> utilities as needed.
          </div>
        </div>
        <div class="card-body">
          <BaseImg
            ...
            alt="..."
          />
          <div style="height: 100px; background-color: rgba(255, 0, 0, 0.1)" class="mt-3">
            <div
              class="mh-100"
              style="
                width: 100px;
          ...
          <div class="card custom-card">
            ...
            <div class="card-body">
              ...
              <p class="pe-none mb-0">
                ...
                <a href="javascript:void(0);" class="pe-auto">this link</a>
                has a
      ...
      <div class="card custom-card">
        ...
        <div class="card-body d-md-flex">
          ...
          <div
            ...
            style="max-width: 260px; max-height: 100px"
          >
            This is an example of using <code>.overflow-hidden</code> on an element with set width
          ...
          <div
            ...
            style="max-width: 260px; max-height: 100px"
          >
            This is an example of using <code>.overflow-visible</code> on an element with set width
            and height dimensions.
          </div>
