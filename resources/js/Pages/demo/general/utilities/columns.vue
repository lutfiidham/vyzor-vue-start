          ...
          <div class="card custom-card">
            ...
            <div class="card-body bd-example-row">
              <p class="mb-4">
                ...
                <span class="text-danger me-2">.me-auto</span>to force sibling columns away from one
                another.
              </p>
              <div class="container">
                <div class="row mb-3">
      ...
      <div class="row">
        ...
        <div class="col-xl-12">
          <div class="card custom-card">
            ...
            <div class="card-body bd-example-row">
              ...
              <p>
                There are also responsive <span class="text-danger">.order-first</span> and
                <span class="text-danger">.order-last</span> classes that change the order of an
                element by applying <span class="text-danger">order: -1</span>
                and
                <span class="text-danger">order: 6</span>, respectively. These classes can also be
        ...
        <div class="col-xl-12">
          <div class="card custom-card">
            ...
            <div class="card-body">
              <p>
                The <span class="text-danger">.col-*</span> classes can also be used outside a
      ...
      <div class="card custom-card">
        <div class="card-body">
          ...
          <div class="clearfix">
            ...
            <p>
              And yet, here you are, still persevering in reading this placeholder text, hoping for
