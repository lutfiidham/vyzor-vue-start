        ...
        <div class="card-body">
          ...
          <div class="card-body pb-0">
            ...
            <p class="card-text bg-light mb-0 p-1 rounded" style="transform: rotate(0)">
              This
              <a href="javascript:void(0);" class="text-warning stretched-link">stretched link</a>
      ...
      <div class="card custom-card">
        ...
        <div class="card-body">
          <div class="bg-light clearfix">
            <button type="button" class="btn btn-primary float-start m-1">
      ...
      <div class="card custom-card">
        ...
        <div class="card-body">
          <a
            href="javascript:void(0)"
            class="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2"
            style="--bs-focus-ring-color: rgba(var(--success-rgb), 0.25)"
          >
            Green focus ring
          </a>
        </div>
