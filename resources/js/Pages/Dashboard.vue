...
function navigateToAction(link) {
  router.visit(link)
}
    ...
    >
      <div>
        ...
        <p class="mb-0 text-muted">
          Selamat datang di Vyzor Dashboard
        </p>
      </div>
                ...
                <div class="d-flex align-items-start">
                  <div class="me-3">
                    <span class="avatar avatar-xl avatar-rounded bg-primary-transparent">
                      <i class="ri-user-smile-line fs-1" />
                    </span>
                  </div>
                  <div>
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                      <button class="btn btn-primary btn-wave" @click="exploreDemo">
                        <i class="ri-eye-line me-1" />Explore Demo
                      </button>
                      <button class="btn btn-outline-secondary btn-wave">
                        <i class="ri-settings-3-line me-1" />Settings
                      </button>
                    </div>
                  </div>
                </div>
            ...
            <div class="d-flex align-items-start justify-content-between">
              <div>
                ...
                <span class="badge bg-primary-transparent">
                  <i class="ri-user-line me-1" />Registered
                </span>
              </div>
              <div>
                <span class="avatar avatar-lg bg-primary-transparent">
                  <i class="ri-user-line fs-4" />
                </span>
              </div>
            </div>
          </div>
            ...
            <div class="d-flex align-items-start justify-content-between">
              <div>
                ...
                <span class="badge bg-success-transparent">
                  <i class="ri-checkbox-circle-line me-1" />Online
                </span>
              </div>
              <div>
                <span class="avatar avatar-lg bg-success-transparent">
                  <i class="ri-user-follow-line fs-4" />
                </span>
              </div>
            </div>
          </div>
            ...
            <div class="d-flex align-items-start justify-content-between">
              <div>
                ...
                <span class="badge bg-info-transparent">
                  <i class="ri-shield-user-line me-1" />Configured
                </span>
              </div>
              <div>
    ...
    <div class="row">
      ...
      <div class="col-xl-6">
        <div class="card custom-card">
          ...
          <div class="card-body">
            <div class="row g-3">
              <div v-for="(action, index) in quickActions" :key="index" class="col-md-6">
                <div
