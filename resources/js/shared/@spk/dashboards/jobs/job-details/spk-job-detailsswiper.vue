...
<template>
  <div class="row">
    <div v-for="(job, index) in card.badges" :key="index" class="col-md-6">
      <div class="card custom-card featured-jobs">
        <div class="card-body">
          <div class="btn-list float-end">
            ...
            ><span><i class="bi bi-heart" /></span></a>
            <a
              href="javascript:void(0);"
            ...
            ><span><i class="bi bi-star-fill" /></span></a>
          </div>
          <div class="d-flex mb-3 flex-wrap gap-2">
            <div>
              <span class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border"><svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24">
                <path
            ...
            <div class="ms-2">
              ...
              <a href="javascript:void(0);"><i class="bi bi-building" /> {{ job.company }}</a>
            </div>
          </div>
          <div class="popular-tags mb-3">
            <a href="javascript:void(0);" class="badge rounded-pill bg-light text-default me-1"><i class="bi bi-geo-alt text-muted" /> {{ job.location }}</a>
            <a href="javascript:void(0);" class="badge rounded-pill bg-light text-default me-1"><i class="bi bi-mortarboard text-muted" /> Graduate</a>
            <a href="javascript:void(0);" class="badge rounded-pill bg-light text-default me-1"><i class="bi bi-clock text-muted" /> Min - 2Years</a>
          </div>
          <div class="d-flex justify-content-between flex-wrap">
            ...
            <a href="javascript:void(0);" class="text-primary fw-medium fs-14">
              Apply Now <i class="fe fe-arrow-right" />
            </a>
          </div>
        </div>
      </div>
