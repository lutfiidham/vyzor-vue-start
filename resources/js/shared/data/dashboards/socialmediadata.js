...
export const SocialMediaOptions = {
  ...
  colors: ['var(--primary-color)', 'rgba(255, 73, 205, 1)', 'rgba(50, 212, 132, 1)'],
  stroke: {
...
export const SocialCards = [
  ...
  Audiencedata = [
    ...
    },
    {
      id: 2,
      country: 'India',
      flag: '/images/flags/india_flag.jpg',
      likes: '12,000',
      change: 18.74,
      count: '25,000',
      arrow: 'down',
    },
    {
      id: 3,
      country: 'Canada',
      flag: '/images/flags/canada_flag.jpg',
      likes: '8,500',
      change: 16.06,
      count: '20,000',
      arrow: 'up',
  ...
  Insightsdata = [
    {
      ...
      image: '/images/media/media-23.jpg',
      date: '02, Feb',
      platform: 'Youtube',
      followers: '9.5k+',
    ...
    },
    {
      ...
      platform: 'Twitter',
      followers: '10k+',
      platformColor: 'success',
    },
    {
      id: 4,
      title: 'Recipe of the Day',
      image: '/images/media/media-26.jpg',
      date: '12, Feb',
      platform: 'Linked In',
      followers: '3.5k',
      platformColor: 'warning',
    },
    {
      id: 5,
      title: 'Fashion Forward',
      image: '/images/media/media-27.jpg',
      date: '11, Feb',
      platform: 'Pinterest',
      followers: '1.6M+',
      platformColor: 'primary',
