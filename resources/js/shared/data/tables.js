...
export const alwaysResponsive = [
  {
    ...
    avatar: '/images/faces/3.jpg',
    collaborators: ['/images/faces/2.jpg', '/images/faces/8.jpg', '/images/faces/2.jpg'],
    progress: '52%',
    progressValue: 52,
    salary: '$10,984.29',
    length: '+4',
  ...
  },
  {
    ...
    collaborators: ['/images/faces/6.jpg', '/images/faces/16.jpg'],
    progress: '45%',
    progressValue: 45,
    salary: '$7,123.21',
    length: '+10',
  },
  {
    ...
    avatar: '/images/faces/5.jpg',
    collaborators: ['/images/faces/3.jpg', '/images/faces/10.jpg', '/images/faces/14.jpg'],
    progress: '21%',
    progressValue: 21,
    salary: '$2,325.45',
    length: '+6',
...
export const hoverableRows = [
  {
    ...
    progress: 52,
    avatars: ['/images/faces/10.jpg', '/images/faces/2.jpg', '/images/faces/8.jpg'],
    extraAvatarsCount: 5,
  },
  {
    src: '/images/faces/2.jpg',
    name: 'Kara Kova',
    email: 'milesakara@gmail.com',
    category: 'Clothing',
    color: 'bg-warning-transparent',
    progress: 40,
    avatars: ['/images/faces/2.jpg', '/images/faces/4.jpg', '/images/faces/6.jpg'],
    extraAvatarsCount: 6,
  },
  {
    src: '/images/faces/16.jpg',
    name: 'Donald Trimb',
    email: 'donaldo21@gmail.com',
  ...
  },
  {
    ...
    name: 'Justin Gaethje',
    email: 'justingae@gmail.com',
    category: 'Sports',
    color: 'bg-danger-transparent',
    progress: 72,
    avatars: ['/images/faces/13.jpg', '/images/faces/4.jpg', '/images/faces/6.jpg'],
    extraAvatarsCount: 5,
  },
]
export const hoverableRow = [
  {
    number: 'IN-2032',
    name: 'Mark Cruise',
    email: 'markcruise24@gmail.com',
    status: 'Paid',
    statusClass: 'bg-success-transparent',
    statusIcon: 'ri-check-fill',
    date: 'Jul 26, 2022',
    avatar: '/images/faces/15.jpg',
  },
  {
  ...
  },
  {
    number: 'IN-2014',
    name: 'Samantha Julie',
    email: 'julie453@gmail.com',
    status: 'Cancelled',
    statusClass: 'bg-danger-transparent',
    statusIcon: 'ri-close-fill',
    date: 'Feb 1, 2022',
    avatar: '/images/faces/5.jpg',
  },
  {
...
export const tableHeadwarning = [
  {
    name: 'Harshrath',
    orderNumber: '#5182-3467',
    date: '24 May 2022',
    status: 'Pending',
    statusClass: 'primary-light',
  },
  {
    name: 'Zozo Hadid',
    orderNumber: '#5182-3412',
    date: '02 July 2022',
    status: 'Pending',
    statusClass: 'primary-light',
  },
  {
    name: 'Martiana',
    orderNumber: '#5182-3423',
    date: '15 April 2022',
    status: 'Rejected',
    statusClass: 'danger-light',
  },
  {
    name: 'Alex Carey',
    orderNumber: '#5182-3456',
    date: '17 March 2022',
    status: 'Processed',
    statusClass: 'success-light',
  },
]
