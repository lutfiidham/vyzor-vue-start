export let defaultRange = { script: `  <input type="range" class="form-range" id="customRange1">` },
  disabledRange = {
    script: ` <input type="range" class="form-range" id="disabledRange" disabled>`,
  },
  rangeWithMinAndMaxValues = {
