...
export const roundedButtonDropdowns = {
  script: `
    <div class="btn-list">
                <div class="btn-group" v-for="(idx,index) in dropdownData.singleDropdownButtons" :key="index">
...
export const outlineButtonDropdowns = {
  script: `
   <div class="btn-list">
...
export const roundedOutlineDropdowns = {
  script: `
     <div class="btn-list">
                <div class="btn-group" v-for="(idx,index) in dropdownData.OutlineButtons" :key="index">
                    <button type="button" :class="btn btn-{idx.class} dropdown-toggle rounded-pill" data-bs-toggle="dropdown" aria-expanded="false">
...
export const autoCloseBehavior = {
  script: `
    <div class="btn-list" >
...
export const dropdownsWithForms = {
  script: `
    <div class="dropdown">
...
export const dropdownMenuCentered = {
  script: `
...
export const responsiveAlignmentEnd = {
  script: `
     <div class="btn-group">
...
export const responsiveAlignmentLeft = {
  script: `
    <div class="btn-group">
...
export const customDropdownMenus = {
  script: `
   <div class="btn-list">
...
export const ghostButtonDropdowns = {
  script: `
   <div class="btn-list">
...
export const nonInteractiveDropdownItems = {
  script: `
