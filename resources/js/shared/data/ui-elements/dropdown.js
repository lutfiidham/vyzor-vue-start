...
export const AlignmentButtons = [
  { id: 1, class: 'primary', text: 'Dropdown', dir: 'dropdown-menu', drop: '' },
  {
    ...
    dir: 'dropdown-menu dropdown-menu-end',
    drop: '',
  },
  {
    id: 3,
    class: 'info',
    text: 'Left, right-aligned lg',
    dir: 'dropdown-menu dropdown-menu-lg-end',
    drop: '',
  },
  {
    id: 4,
    class: 'warning',
    text: 'Right, left-aligned lg',
    dir: 'dropdown-menu dropdown-menu-end dropdown-menu-lg-start',
    drop: '',
  },
