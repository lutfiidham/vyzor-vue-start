export const borderCards = [
  {
    ...
    images: ['/images/faces/2.jpg', '/images/faces/8.jpg', '/images/faces/2.jpg'],
    Color: 'primary',
    Class: 'primary',
  },
  {
    ...
    images: ['/images/faces/4.jpg', '/images/faces/6.jpg'],
    Color: 'secondary',
    Class: 'secondary',
  },
  {
  ...
  },
  {
    ...
    images: ['/images/faces/3.jpg', '/images/faces/14.jpg', '/images/faces/11.jpg'],
    Color: 'info',
    Class: 'info',
  },
  {
  ...
  },
  {
    ...
    images: ['/images/faces/6.jpg', '/images/faces/9.jpg'],
    Color: 'success',
    Class: 'success',
  },
  {
    ...
    images: ['/images/faces/5.jpg', '/images/faces/6.jpg', '/images/faces/7.jpg'],
    Color: 'light',
    Class: 'default',
  },
  {
    title: 'Terminated Employees',
    badges: [{ text: 'Angular', className: 'bg-primary-transparent' }],
    images: [
      '/images/faces/9.jpg',
      '/images/faces/11.jpg',
      '/images/faces/12.jpg',
